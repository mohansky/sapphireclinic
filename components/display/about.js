...
export default function About() {
  return (
    <>
      <section className="relative mb-12 px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-8">
        ...
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8">
            ...
            <p className="mt-2 leading-relaxed">
              ...
              treatment to the unique needs of each individual to ensure that
              the results are long lasting. After a detailed diagnosis, we help
              you understand the needs, and formulate a treatment plan to cater
              to what is best and safe for you. We help you achieve a complete
              ...
              and treatment always give superior results. Our highly trained
              team of doctor, aestheticians and nurses along with reliable
              leading edge medical technology deliver unsurpassed results in
              Botox, Fillers, Peels, Lasers, Thread-lifts, Hair Transplants,
              Body Contouring.
            </p>
          </div>
            ...
            <div className="md:flex mt-8">
              <div className="mt-4 md:mt-0">
                ...
                <p className="mt-2 leading-relaxed">
                  ...
                  luxury at our state-of-the art clinic, where each individual
                  is given personal attention, safest treatments and utmost
                  discretion.
                </p>
                <p className="mt-2 leading-relaxed">
      ...
      {/* <section className="relative px-4 py-4 sm:px-8 lg:px-8 xl:px-40 2xl:px-64 lg:py-16">
        <div className="flex flex-col lg:flex-row lg:-mx-8">
          <div className="w-full lg:w-1/2 lg:px-8 mt-12 lg:mt-0">
            <div className="md:flex">
              <Image src="/images/ful.jpg" width={720} height={480} alt="" />
