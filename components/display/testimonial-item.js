      ...
      <div className="bg-no-repeat bg-cover bg-center h-96 md:px-24 p-6 mb-6 z-10 grid  ">
        <div className=" items-center">
          <div className="text-center">
            <h3 className=" text-6xl text-white font-bold mb-8 z-50">
              Our patients&apos; Say
            </h3>
            <Icon icon="mingcute:quote-left-line" className="mt-15 hidden lg:block mx-auto opacity-40 text-scred w-28 h-28"/>
